...
@protocol XRTextDeleteDelegate <NSObject>
...
@interface XRDeleteTextField : UITextField

@property (nonatomic, assign) id<XRTextDeleteDelegate> deleteDelegate;
@property (nonatomic, assign) CGFloat width;

@end

#pragma mark -
@implementation XRDeleteTextField
...
@interface JFInputBubbleItem ()<XRTextDeleteDelegate, UITextFieldDelegate>
@property (nonatomic, strong) XRDeleteTextField *inputLabelField;/**< 输入分组 */
...
-(id)initWithReuseIdentifier:(NSString *)identifier{
    ...
    if (self) {
        self.inputLabelField = ({
            XRDeleteTextField *textField = [[XRDeleteTextField alloc] init];
...
-(CGFloat)widthByHeight:(CGFloat)height{
    ...
    return [string widthByFont:self.inputLabelField.font maxHeight:height];
}
